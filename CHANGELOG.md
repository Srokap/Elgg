...
* **updates:** Updating contributing docs to point to feedback and planning group and to mention the commit message format. ([c10f09f8](https://github.com/Elgg/Elgg/commit/c10f09f868a3b7b6b00c2e9fe829284894fe125f))
...
* **core:**
  * prevents upgrade scripts from attempting to create the same ElggUpgrade more than once ([3d5fc912](https://github.com/Elgg/Elgg/commit/3d5fc912e329e9033bbf06499c809581fc3386a0), closes [#6824](https://github.com/Elgg/Elgg/issues/6824))
...
* **upgrade:**
  ...
  * Setting time_updated and last_action for migrated comment and discussion entities. ([ed7cf3bc](https://github.com/Elgg/Elgg/commit/ed7cf3bcca5c899618dca2279962ebc3b43893ea), closes [#6395](https://github.com/Elgg/Elgg/issues/6395))
